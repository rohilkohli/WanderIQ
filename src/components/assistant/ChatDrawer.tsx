    ...
    <>
      ...
      >
        ...
        <div style={{
          ...
          <div style={{ flex: 1 }}>
            <h2 style={{ fontSize: '1rem', fontFamily: 'var(--font-display)', marginBottom: 2 }}>
              AI Travel Assistant
            </h2>
            <p style={{ fontSize: '0.75rem', color: 'var(--color-text-muted)' }}>
              Powered by Gemini · Always ready
            </p>
          </div>
          <button
            onClick={onClose}
        ...
        >
          {messages.length === 0 && (
            <div style={{ textAlign: 'center', padding: 'var(--space-8) 0' }}>
              ...
              <h3 style={{ fontFamily: 'var(--font-display)', fontSize: '1.25rem', marginBottom: 'var(--space-2)' }}>
                Your travel companion
              </h3>
              <p style={{ color: 'var(--color-text-muted)', fontSize: '0.875rem', lineHeight: 1.6 }}>
                Ask me anything about your trip — restaurants, packing, routes, budget tips, and more.
              </p>
          ...
          {messages.map((msg, i) => (
            <div
              ...
              style={{
                ...
                gap:       'var(--space-3)',
                animation: `${msg.role === 'user' ? 'slideInLeft' : 'slideInRight'} 250ms ease-out`,
            ...
            >
              ...
              <div style={{
                ...
                height:         32,
                borderRadius:   '50%',
                background:     msg.role === 'user' ? 'var(--color-highlight)' : 'linear-gradient(135deg, var(--color-accent), #2D9CDB)',
                display:        'flex',
                alignItems:     'center',
                justifyContent: 'center',
                fontSize:       '0.875rem',
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', gap: 'var(--space-2)', alignItems: 'flex-end' }}>
            ...
            <button
              ...
              style={{ padding: 'var(--space-3)', minHeight: 'auto', borderRadius: 'var(--radius-lg)', alignSelf: 'flex-end' }}
              aria-label="Send message"
            >
              {isLoading ? (
                <span style={{ display: 'block', width: 16, height: 16, border: '2px solid rgba(255,255,255,0.4)', borderTopColor: 'white', borderRadius: '50%', animation: 'spin 1s linear infinite' }} />
              ) : '↑'}
            </button>
          </div>
