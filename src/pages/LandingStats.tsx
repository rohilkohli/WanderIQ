...
export const LandingStats: React.FC = () => {
  return (
    <section aria-label="VoyaIQ by the numbers" style={{ background: "var(--color-accent)", padding: "var(--space-8) var(--space-8)", display: "flex", justifyContent: "center", gap: "var(--space-16)", flexWrap: "wrap" }}>
      {STATS.map((s) => (
